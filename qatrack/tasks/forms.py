...
class BasicTaskForm(forms.ModelForm):
    class Meta:
        model = Task

    def clean(self):
        """do some custom form validation"""
        cleaned_data = super(BasicTaskForm, self).clean()
...
class AddOrEditTaskForm(BasicTaskForm):
    def __init__(self, *args, **kwargs):
        super(AddOrEditTaskForm, self).__init__(*args, **kwargs)
...
class PerformTaskForm(forms.ModelForm):
    class Meta:
        model = Task
        fields = ['comment_for_reviewer', 'status']

    def __init__(self, *args, **kwargs):
        super(PerformTaskForm, self).__init__(*args, **kwargs)
        self.helper = FormHelper()
        self.helper.form_id = 'task-form'
        self.helper.form_method = 'post'
        self.helper.form_action = '.'
