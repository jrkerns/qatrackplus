...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tasks_task', 'due_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Task.description'
        db.alter_column('tasks_task', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Task.overdue_date'
        db.alter_column('tasks_task', 'overdue_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Task.due_date'
        db.alter_column('tasks_task', 'due_date', self.gf('django.db.models.fields.DateField')(default=1))

        # Changing field 'Task.description'
        db.alter_column('tasks_task', 'description', self.gf('django.db.models.fields.TextField')(default=1))

        # Changing field 'Task.overdue_date'
        db.alter_column('tasks_task', 'overdue_date', self.gf('django.db.models.fields.DateField')(default=1))
    ...
    models = {
        ...
        'tasks.task': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tasks.Category']"}),
            'comment_for_reviewer': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'due_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'edit_groups': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'groups edit'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['auth.Group']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'overdue_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'not_done'", 'max_length': '15'}),
