...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.date_modified'
        db.delete_column('tasks_task', 'date_modified')

        # Adding field 'Task.date_created'
        db.add_column('tasks_task', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 25, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.date_modified'
        db.add_column('tasks_task', 'date_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 6, 25, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Task.date_created'
        db.delete_column('tasks_task', 'date_created')
