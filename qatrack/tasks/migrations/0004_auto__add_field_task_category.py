...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tasks_task', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tasks.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.category'
        db.delete_column('tasks_task', 'category_id')
