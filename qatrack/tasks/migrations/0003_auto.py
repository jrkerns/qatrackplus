...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field edit_groups on 'Task'
        m2m_table_name = db.shorten_name('tasks_task_edit_groups')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field edit_groups on 'Task'
        db.delete_table(db.shorten_name('tasks_task_edit_groups'))
